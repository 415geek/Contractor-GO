...
const StaffManager = () => {
  ...
  const avgPerformance = staffMembers.reduce((sum, staff) => sum + staff.performance, 0) / staffMembers.length;
            ...
            <div key={staff.id} className="border rounded-lg p-4 hover:shadow-md transition-shadow">
              ...
              <div className="flex items-center justify-between">
                <div className="text-xs text-gray-500">
                  Weekly cost: ${(staff.hoursThisWeek * staff.hourlyRate).toFixed(2)}
                </div>
